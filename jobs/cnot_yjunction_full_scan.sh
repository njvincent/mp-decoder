...
#SBATCH --mem=32G
#SBATCH --output=logs/cnot_yjunction_full_scan_%A_%a.out
#SBATCH --error=logs/cnot_yjunction_full_scan_%A_%a.err
...
OUTPUT_DIR=${OUTPUT_DIR:-results/cnot_yjunction/full_scan/T∕2_CNOT_T∕2_2T}
