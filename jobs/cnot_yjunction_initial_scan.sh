...
#SBATCH --mem=32G
#SBATCH --output=logs/cnot_yjunction_initial_scan_%A_%a.out
#SBATCH --error=logs/cnot_yjunction_initial_scan_%A_%a.err
...
NREPEATS=${2:-1}
MAX_CONCURRENT=${3:-20}
JULIA_SCRIPT=${JULIA_SCRIPT:-2d_windowed_cnot_yjunction.jl}
THREADS_PER_TASK=${THREADS_PER_TASK:-${SLURM_CPUS_PER_TASK:-8}}
SUBMIT_DIR=${SLURM_SUBMIT_DIR:-$(pwd)}
PROJECT_DIR=${PROJECT_DIR:-${SUBMIT_DIR}}
OUTPUT_DIR=${OUTPUT_DIR:-results/cnot_yjunction/initial_scan/T∕2_CNOT_T∕2_2T}
...
CNOT_STYLE=${CNOT_STYLE:-yjunction}
